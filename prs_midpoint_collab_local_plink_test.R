...
write_review_md <- function(bundle_dir, score_file, summary_file, plink_path, n_people, n_snps) {
  lines <- c(
    ...
    "- Cohort flow table: `outputs/tables/cohort_flow_counts.csv`",
    "- PheWAS table: `outputs/tables/phewas_results.csv`",
    "- Plot source tables: `outputs/tables/association_forest_plot_data.csv`, `outputs/tables/midpoint_by_prs_tertile_plot_data.csv`, `outputs/tables/phewas_manhattan_plot_data.csv`, `outputs/tables/phewas_volcano_plot_data.csv`",
    "- Plots: `outputs/plots/association_forest_per_sd.png`, `outputs/plots/midpoint_by_prs_tertile.png`, `outputs/plots/cohort_flow.png`, `outputs/plots/phewas_manhattan.png`, `outputs/plots/phewas_volcano.png`",
    "",
    "## Notes",
    "",
